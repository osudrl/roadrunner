...
# print(np.array(DIGIT_MOTOR_NAME))
# print(np.array(DIGIT_MOTOR_NAME_LLAPI)[DIGIT_MOTOR_NAME_LLAPI_INDEX])
...
# for name in DIGIT_JOINT_NAME:
#   DIGIT_JOINT_NAME_LLAPI_INDEX.append(DIGIT_JOINT_NAME_LLAPI.index(name))
# print(DIGIT_JOINT_NAME_LLAPI_INDEX)
# print(np.array(DIGIT_JOINT_NAME))
# print(np.array(DIGIT_JOINT_NAME_LLAPI)[DIGIT_JOINT_NAME_LLAPI_INDEX])
