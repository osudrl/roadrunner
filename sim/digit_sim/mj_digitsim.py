...
class MjDigitSim(MujocoSim):
    ...
    def __init__(self, model_name: str = "digit-v3-new.xml", terrain=None):
        ...
        self.torque_delay_cycles = int(np.random.uniform(6, 10))
        ...
        self.arm_action_inds = [6, 7, 8, 9, 16, 17, 18, 19]
        ...
        self.reset_qpos = np.array([0, 0, 1,  1, 0 ,0 ,0,
                        ...
                        -1.05542715e-01, 8.94852532e-01, -8.63756398e-03, 0.44780280e-01,
                        ...
                        1.05444698e-01, -8.94890429e-01, 8.85979401e-03, -0.44723293e-01
                        ])
        ...
        self.body_collision_list = ['torso/base', 'left-leg/hip-pitch', 'right-leg/hip-pitch']
        self.body_collision_list += ['left-leg/toe-a-rod', 'left-leg/toe-b-rod',\
